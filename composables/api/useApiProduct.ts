...
import type { ApiProductListResponse, ApiProductResponse, ProductData, ProductParams, ProductPayload } from '~/types/responses/product-response'
...
export function useApiProduct() {
  ...
  const findId = async (
    id: number,
    options?: Partial<ApiFetchOptions<ApiProductResponse>>,
  ) => {
